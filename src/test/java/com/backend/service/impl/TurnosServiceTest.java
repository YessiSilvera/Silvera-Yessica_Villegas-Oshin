...
class TurnosServiceTest {
    ...
    void setup() {
        ...
        if (odontologoId == null) {
            OdontologoDtoEntrada odontologoDtoEntrada = new OdontologoDtoEntrada(112233L, "Felipe", "Silvera");
        ...
        if (pacienteId == null) {
            DomicilioEntradaDto domicilioEntradaDto = new DomicilioEntradaDto("Charles Sutton", 230, "Lima", "Peru");
            PacienteDtoEntrada pacienteDtoEntrada = new PacienteDtoEntrada(12345L, "Juan", "Perez", LocalDate.now(), domicilioEntradaDto);
