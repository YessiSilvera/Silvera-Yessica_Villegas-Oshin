...
class PacienteServiceTest {
    ...
    void shouldSaveAPatientCorrectly() {
        DomicilioEntradaDto domicilioEntradaDto = new DomicilioEntradaDto("Obligado", 1309, "Pocitos", "Montevideo");
        PacienteDtoEntrada pacienteDtoEntrada = new PacienteDtoEntrada(312789, "Yessica", "Silvera", LocalDate.now(), domicilioEntradaDto);
